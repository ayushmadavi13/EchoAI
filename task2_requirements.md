...
## Dataset
We will provide the dataset to build your RAG pipeline on:
...
### 3. Latency target
The full process — chunking + vector DB retrieval + everything through to final output — should complete in **under 50ms**.
