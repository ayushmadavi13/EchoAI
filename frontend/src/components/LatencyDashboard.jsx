      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            {LATENCY_METRICS.map((metric, idx) => (
              <motion.div 
                ...
                className="glass-panel p-6 flex items-center justify-between transition-all duration-300"
              >
                <div>
          ...
          <motion.div 
            ...
            className="lg:col-span-2 glass-panel p-8 flex flex-col justify-between"
          >
            <div>
            ...
            <div className="flex items-center justify-between border-t border-white/10 pt-6 mt-8">
              ...
              <motion.div 
                ...
                className="flex items-center gap-2 text-[#5BE17C] bg-[#5BE17C]/10 border border-[#5BE17C]/20 px-4 py-2 rounded-xl"
              >
