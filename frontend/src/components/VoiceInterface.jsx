  ...
  return (
    <section id="voice-interface" className="relative py-24 border-y border-white/10 overflow-hidden">
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <div className="glass-panel p-8 mb-8">
          <div className="flex flex-col items-center justify-center py-6">
            ...
            <div className="relative mb-6">
              {/* Outer Glass Ring */}
              <div className="mic-outer-glass p-4 rounded-full">
                <button
                  onClick={isRecording ? stopRecording : startRecording}
                  disabled={isLoading}
                  className={`flex items-center justify-center w-24 h-24 rounded-full transition-all duration-300 focus:outline-none bg-black text-white hover:bg-neutral-950 ${
                    isRecording ? 'scale-95' : 'hover:scale-105'
                  } ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                  style={{
                    boxShadow: isRecording ? '0 0 25px rgba(255,255,255,0.2)' : 'none'
                  }}
                >
            ...
            <div className="text-center mb-8">
              {isRecording ? (
                ...
                <div>
                  <span className="text-sm font-semibold text-[#A0A0A0] uppercase tracking-wider">Processing Pipeline...</span>
        ...
        {/* Error Message */}
        {error && (
          <div className="p-4 mb-6 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 text-sm flex gap-3 items-center">
